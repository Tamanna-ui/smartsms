...
def resolve_runtime_dir() -> Path:
    explicit_dir = os.getenv("SMART_SMS_RUNTIME_DIR")
    if explicit_dir:
        return Path(explicit_dir)

    temp_root = os.getenv("TMPDIR") or os.getenv("TEMP") or os.getenv("TMP")
    if temp_root:
        return Path(temp_root) / "smart_sms_shield"

    return BASE_DIR / "instance"


RUNTIME_DIR = resolve_runtime_dir()
DATABASE_PATH = RUNTIME_DIR / "message_history.json"
